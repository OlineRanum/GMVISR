...
def train(args):
    ...
    logger = pl.loggers.WandbLogger(project=args.wandb_log_folder+"_final", name=args.model_name, config=args, save_dir=args.wandb_log_folder)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_targets', type=str, default=2,
                        help='Number of sign classes')
